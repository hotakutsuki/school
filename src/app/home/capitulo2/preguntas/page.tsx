...
const questions: Question[] = [
    {
        id: 1,
        question: "¿Cuál es el objetivo principal de los conceptos avanzados?",
        options: [
            "Complicar el aprendizaje innecesariamente",
            "Profundizar y ampliar el conocimiento",
            "Repetir lo aprendido en el capítulo anterior",
            "Evitar la práctica"
        ],
        correctAnswer: 1
    },
    {
        id: 2,
        question: "¿Qué debes hacer si encuentras dificultades con los temas avanzados?",
        options: [
            "Ignorar los temas difíciles",
            "Buscar recursos adicionales y practicar",
            "Dejar el curso incompleto",
            "Solo leer los títulos"
        ],
        correctAnswer: 1
    },
    {
        id: 3,
        question: "¿Cuál es una buena práctica al estudiar conceptos avanzados?",
        options: [
            "Estudiar de manera superficial",
            "Aplicar los conceptos en proyectos reales",
            "Evitar hacer preguntas",
            "No repasar el material"
        ],
        correctAnswer: 1
    },
    {
        id: 4,
        question: "¿Qué actitud es recomendable para el aprendizaje avanzado?",
        options: [
            "Ser curioso y perseverante",
            "Rendirse ante la primera dificultad",
            "No buscar ayuda",
            "Estudiar solo si es obligatorio"
        ],
        correctAnswer: 0
    }
];

export default function Capitulo2Preguntas() {
            ...
            <div className="max-w-4xl mx-auto">
                <div className="bg-white rounded-lg shadow-sm p-6 lg:p-8">
                    <h1 className="text-3xl font-bold text-gray-900 mb-6">
                        Resultados del Cuestionario - Capítulo 2
                    </h1>
